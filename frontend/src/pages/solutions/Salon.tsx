  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Salon & Spa POS Solution</h1>
          <p className="text-xl text-gray-600 mb-8">
            Manage your beauty business with our specialized POS system designed for salons and spas.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>• Staff scheduling and commissions</li>
                <li>• Client profiles and history</li>
                <li>• Inventory for products</li>
