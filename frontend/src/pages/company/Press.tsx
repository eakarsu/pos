...
import { CalendarIcon, DocumentTextIcon, PhotoIcon } from '@heroicons/react/24/outline';

const Press: React.FC = () => {
  const pressReleases = [
    {
      date: 'March 15, 2024',
      title: 'POS Pro Announces $50M Series B Funding Round',
      excerpt: 'Funding will accelerate product development and international expansion as company reaches 10,000+ active merchants.',
      category: 'Funding'
    },
    {
      date: 'February 8, 2024',
      title: 'POS Pro Launches AI-Powered Inventory Management',
      excerpt: 'New machine learning features help retailers optimize stock levels and reduce waste by up to 30%.',
      category: 'Product'
    },
    {
      date: 'January 22, 2024',
      title: 'POS Pro Named "Best POS System" by Retail Tech Awards',
      excerpt: 'Recognition highlights company\'s commitment to innovation and customer satisfaction in the retail technology space.',
      category: 'Awards'
    },
    {
      date: 'December 10, 2023',
      title: 'POS Pro Expands to European Markets',
      excerpt: 'Company launches operations in UK, Germany, and France, bringing total addressable market to over 2 million businesses.',
      category: 'Expansion'
    }
  ];
  ...
  const mediaKit = [
    {
      icon: PhotoIcon,
      title: 'Brand Assets',
      description: 'Logos, brand guidelines, and product screenshots',
      downloadLink: '#'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-indigo-100 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Latest news, press releases, and media resources from POS Pro.
          </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Latest Press Releases</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mediaKit.map((item, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 text-center">
                ...
                <a href={item.downloadLink} className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors inline-block">
                  Download
                </a>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-2">Sarah Johnson</h3>
              <p className="text-gray-600 mb-1">Director of Communications</p>
              <p className="text-gray-600 mb-1">press@pospro.com</p>
